...
dataset_path = r'D:\mini project\brain tumor\mytraining'
...
# Print the shapes of the arrays after shuffling
print(f'X_train shape after shuffling: {X_train.shape}')
print(f'y_train shape after shuffling: {y_train.shape}')

# Split data into training and test sets
X_train, X_test, y_train, y_test = train_test_split(X_train, y_train, test_size=0.2, random_state=42)

# Print the shapes of the arrays after splitting
